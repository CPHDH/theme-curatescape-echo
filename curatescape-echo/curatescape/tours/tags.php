<?php
echo head(array('maptype'=>'none', 'title'=>__('%s Tags',rl_tour_label(false)),'bodyid'=>'tours','bodyclass'=>'browse tags'));
?>
<div id="content" role="main">
    <article class="browse tags">
        <div class="browse-header">
            <h2 class="query-header"><?php echo __('%1s Tags: %2s', rl_tour_label(false), count($tags));?></h2>
