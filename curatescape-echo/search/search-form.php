<?php echo $this->form('search-form', $options['form_attributes']); ?>
    ...
    <div id="advanced-form">
        ...
        <fieldset id="record-types">
            ...
            <div class="checkbox-item"><?php echo $this->formCheckbox('record_types[]', $key, array('checked' => in_array($key, $filters['record_types']), 'id' => 'record_types-' . $key)); ?> <?php echo $this->formLabel('record_types-' . $key, $value);?></div>
            <?php endforeach; ?>
        </fieldset>
        <?php endif; ?>
    </div>
